            ...
            <div class="page-content">
                    ...
                    <div class="container">
                        <div class="heading">
                            <div class="left">
                                ...
                                <p class="light-black">{!! $info->last_match_result_short_desc !!}
                                </p>
                            </div>
                                    ...
                                    <div class="teams">
                                        <div class="team">
                                            <div class="team-logo-name">
                                                <img
                                                    src="assets/media/brands/southafrica_cricket_logo.png"
                                                    alt>
                                                <h5 class="light-black">SA
                                                    Cricket</h5>
                                            </div>
                                            <h5 class="light-black">270 <span
                                                    class="dark-gray">(48)</span></h5>
                                        </div>
                                        <div class="team">
                                            <h5 class="light-black">271/3 <span
                                                    class="dark-gray">(39)</span></h5>
                                            <div class="team-logo-name">
                                                <img
                                                    src="assets/media/brands/action_cricket_logo.png"
                                                    alt>
                                ...
                                <div class="item">
                                    ...
                                    <div class="teams">
                                        <div class="team">
                                            <div class="team-logo-name">
                                                <img
                                                    src="assets/media/brands/logo.png"
                                                    alt>
                                                <h5 class="light-black">Derbyshire</h5>
                                            </div>
                                            <h5 class="light-black">164 <span
                                                    class="dark-gray">(42)</span></h5>
                                        </div>
                                        <div class="team">
                                            <h5 class="light-black">165/5 <span
                                                    class="dark-gray">(39)</span></h5>
                                            <div class="team-logo-name">
                                                <img
                                                    src="assets/media/brands/knights_Cricket_logo.png"
                                                    alt>
                                ...
                                <div class="item">
                                    <div class="teams">
                                        <div class="team">
                                            ...
                                            <h5 class="light-black">184/6 <span
                                                    class="dark-gray">(42)</span></h5>
                                        </div>
                                        <div class="team">
                                            <h5 class="light-black">180/5 <span
                                                    class="dark-gray">(39)</span></h5>
                                            <div class="team-logo-name">
                                                <img
                                                    src="assets/media/brands/knights_Cricket_logo.png"
                ...
                <section class="achievement">
                    <div class="celebrattion-image">
                        <img
                            src="assets/media/achievement/celebration-image.png"
                            alt>
                    </div>
                    <div class="container">
                        <div class="row">
                    ...
                    <div class="container">
                        <div class="heading">
                            <div class="left">
                                ...
                                <p class="light-black">{!! $info->upcoming_match_short_desc !!}
                                </p>
                            </div>
                        ...
                        <div class="list-block">
                            <div class="list-item">
                                <div class="teams-location">
                                    ...
                                    <div class="location">
                                        ...
                                        <h6 class="light-black"> Oceanfront
                                            Cricket Arena</h6>
                                    </div>
                                </div>
                                <div class="timing">
                                    <h6 class="light-black">ONE DAY MATCH</h6>
                                    <a href="match-schedule.html" class="cus-btn primary">1:30PM
                            ...
                            <div class="list-item">
                                ...
                                <div class="timing">
                                    ...
                                    <h6 class="light-black">28 Oct, 2023</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="gallery p-40">
                    <div class="container">
                        <div class="heading">
                            <div class="left">
                                <h2 class="light-black">{{ $info->gallery }}</h2>
                                <p class="light-black">{!! $info->gallery_short_desc !!}
                                </p>
                            </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6 col-12 offset-lg-6">
                                <div class="content">
                                    <h2 class="color-white text-xl-center">{{ $info->ready_to_play }}</h2>
                    ...
                    <div class="container">
                        <div class="heading">
                            <div class="left">
                                ...
                                <p class="light-black">{!! $info->meet_the_team_short_desc !!}
                                </p>
                            </div>
                        ...
                        <div class="team-slider">
                            ...
                            <a href="team.html" class="team-member">
                                <div class="content">
                                    ...
                                    <img
                                        src="assets/media/cricketer/img-4.png"
                                        alt>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="container">
                        <div class="heading">
                            <div class="left">
                                ...
                                <p class="light-black">{!! $info->testimonial_short_desc !!}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="blog-card mb-lg-0 mb-24">
                                    <img src="assets/media/blog/img-1.png" class="w-100" alt="">
                                    <div class="info">
                                        <div class="date-author mb-12">
                                            ...
                                            <div class="author">
                                                ...
                                                <img src="assets/media/blog/author.png" alt="">
                                            </div>
                                        </div>
