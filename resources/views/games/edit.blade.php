                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.games.update', $game->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="score_team_1" id="score_team_1" class="form-control" placeholder="Enter Score for Team 1" value="{{ $game->score_team_1 }}">
                                </div>

                                <div class="form-group">
                                    <label for="score_team_2">Score Team 2</label>
                                    <input type="number" name="score_team_2" id="score_team_2" class="form-control" placeholder="Enter Score for Team 2" value="{{ $game->score_team_2 }}">
                                </div>

                                <div class="form-group">
                                    <label for="match_details">Match Details</label>
                                    <textarea name="match_details" id="match_details" class="form-control" rows="3" placeholder="Enter Match Details">{{ $game->match_details }}</textarea>
                                </div>
